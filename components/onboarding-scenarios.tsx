  ...
  return (
    <Dialog open onOpenChange={() => onClose()}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle>Onboarding Scenarios — {site?.name}</DialogTitle>
        </DialogHeader>
        <div className="space-y-4 text-sm text-slate-700">
          <p>
            Guided steps for Corporate, BYOD, Guest, and IoT onboarding, including certificate enrollment, profile
            installation, and VLAN segmentation.
          </p>
          <ol className="list-decimal pl-5 space-y-1">
            <li>Device connects to onboarding SSID or registration VLAN</li>
            <li>Captive portal presents options based on role</li>
            <li>For Corporate: MDM enrollment, cert profile, 802.1X configured</li>
            <li>For BYOD: WPA2-Enterprise profile with user cert or username/password</li>
            <li>Guest: Sponsored credentials with expiration and limited access</li>
            <li>IoT: MAC-based or certificate-based auth with dedicated VLAN</li>
            <li>Policy decision triggers CoA to move device into target VLAN/ACL</li>
          </ol>
        </div>
                    ...
                    >
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-muted-foreground">~{scenario.totalDuration}s</span>
                        </div>
                      </CardContent>
                    </Card>
                  ))}
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button onClick={startSimulation} disabled={isPlaying} size="sm">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div>
                        ...
                        <span className="text-sm text-muted-foreground">{currentScenario.deviceType}</span>
                      </div>
                      <div>
