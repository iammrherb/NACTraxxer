...
const demoSites: Site[] = [
  {
    ...
    notes:
      "Executive network needs priority handling. Board room has custom AV equipment requiring special considerations for IoT device authentication.",
  },
  {
    id: "ABM-DC002",
    ...
    notes:
      "24/7 operation requires careful change windows. Critical infrastructure with redundant authentication paths.",
  },
  {
    id: "ABM-EUR003",
    name: "European HQ",
  ...
  },
  {
    ...
    notes:
      "Manufacturing floor required special considerations for IoT devices. Implemented using certificates for device authentication. Project completed ahead of schedule.",
  },
  {
    id: "ABM-RD007",
    ...
    notes:
      "Specialized lab equipment needs custom authentication. Research environment requires flexible access policies.",
  },
]
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Site Management</h2>
          <p className="text-gray-600 dark:text-gray-400">Manage and track NAC deployment sites</p>
        </div>
        <div className="flex space-x-2">
          {sites.length === 0 && (
            <Button onClick={loadDemoData} variant="outline" className="flex items-center space-x-2 bg-transparent">
              <Database className="h-4 w-4" />
              <span>Load Demo Sites</span>
            </Button>
          )}
          {sites.length > 0 && (
            <Button
      ...
      {sites.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Get started by adding your first site or loading demo data
          </p>
        ...
        <>
                      ...
                      <TableRow key={site.id}>
                        ...
                        <TableCell>
                          <div className="space-y-2">
                            ...
                            <span className="text-sm text-muted-foreground">{site.completionPercent}%</span>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="flex space-x-2">
          ...
          <Dialog open={!!selectedSite} onOpenChange={() => setSelectedSite(null)}>
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>Site ID: {selectedSite?.id}</DialogDescription>
              </DialogHeader>
                ...
                <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <Badge variant={getPriorityColor(selectedSite.priority)}>{selectedSite.priority}</Badge>
                          </div>
                          <div className="flex justify-between">
                  ...
                  {selectedSite.notes && (
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground bg-muted p-3 rounded-lg">{selectedSite.notes}</p>
                    </div>
                  )}
                </div>
              )}
          ...
          <AddSiteModal open={showAddModal} onOpenChange={setShowAddModal} onAddSite={handleAddSite} />
        </>
      )}
    </div>
  )
