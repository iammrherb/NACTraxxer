...
INSERT INTO use_cases (title, description, category, priority, status, completion_percentage) VALUES
('Employee Device Authentication', 'Secure authentication for employee-owned devices accessing corporate resources', 'Authentication', 'High', 'Active', 80),
('Guest Network Access', 'Controlled internet access for visitors and contractors', 'Network Access', 'Medium', 'Active', 60),
('IoT Device Management', 'Automated onboarding and policy enforcement for IoT devices', 'Device Management', 'High', 'Active', 45),
('BYOD Policy Enforcement', 'Bring Your Own Device policy compliance and security', 'Policy', 'High', 'Active', 70),
('Contractor Access Control', 'Temporary access provisioning for external contractors', 'Access Control', 'Medium', 'Draft', 20);
